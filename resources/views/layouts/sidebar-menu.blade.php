    ...
    <ul>
        ...
        <li class="submenu active">
            <a href="#"><i class="fas fa-chalkboard-teacher"></i> <span> Teachers</span> <span
                    class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="{{ route('list') }}" @if(Request::is('list')) class="active" @endif>Teacher List</a></li>
                        <li><a href="{{ route('view') }}" @if(Request::is('view')) class="active" @endif>Teacher View</a></li>
                        <li><a href="{{ route('add') }}" @if(Request::is('add')) class="active" @endif>Teacher Add</a></li>
                        <li><a href="{{ route('edit') }}" @if(Request::is('edit')) class="active" @endif>Teacher Edit</a></li>
                    </ul>
        </li>
        <li class="submenu">
