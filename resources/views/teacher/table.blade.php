    ...
    <div class="student-group-form">
        <form action="{{ route('document.search') }}" method="GET">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="form-group">
                        <input type="text" name="search_titre" class="form-control" placeholder="Search by Titre ..."
                            value="{{ request('search_titre') }}">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        <input type="text" name="search_extension" class="form-control"
                            placeholder="Search by Extension ..." value="{{ request('search_extension') }}">
                    </div>
                </div>
                <div class="col-lg-2">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="{{ route('document.downloadCsv') }}" class="btn btn-outline-primary me-2"><i
                                        class="fas fa-download"></i> Download CSV</a>
                                            ...
                                            <div class="actions">
                                                ...
                                                <form action="{{ route('document.edit', $document->id) }}"
                                                    ...
                                                    <button type="submit" class="btn btn-sm bg-danger-light">
                                                        <i class="feather-edit"><a data-id="{{ $document->id }}"
                                                ...
                                                <form
                                                    action="{{ route('document.delete', $document->id) }}"method="POST"
                                                    class="d-inline">
                                                    ...
                                                    <button type="submit" class="btn btn-sm bg-danger-light delete-btn"
                                                        ...
                                                        <i class="feather-trash-2"><a data-id="{{ $document->id }}"
                                                                style="display: none" href="#"></a></i>
                                                    </button>
